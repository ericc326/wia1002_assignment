...
public class Residents {
    ...
    public void sort(String place, int currentDay) {
        ...
        String order = "";
        String[] basedOrder = { "Destructive Power", "Speed", "Range", "Stamina", "Precision",
        ...
        for (Map.Entry<String, List<String>> entry : standOnly.entrySet()) {
            ...
            if (values.size() == 11) {
                standOnly.put(key, Arrays.asList(values.get(0), values.get(1), values.get(3), values.get(4),
    ...
    public void readForMenu(int currentDay) {
        ...
        try {
            ...
            while (scan.hasNextLine()) {
                ...
                if (!(features[0].equals("Jonathan Joestar") || features[0].equals("Joseph Joestar")
                        || features[0].equals("Jotaro Kujo") || features[0].equals("Josuke Higashikata")
                        || features[0].equals("Giorno Giovanna") || features[0].equals("Jolyne Cujoh"))) {
