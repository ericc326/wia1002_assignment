...
public class Residents_P2 {
    public ArrayList<String> Name, Age, Gender, ResidentialArea, Parents, newName, newAge, newGender, newParent, newStand,
    ...
    public void option1(String place) {
        ...
        switch (choose) {
            ...
            case 1:
                System.out.println("Choose the next location");
                break;
            case 2:
                readRes();
                printRes(place);
                break;
            case 3:
                System.out.println("Move back to prevoius location");
                break;
            case 4:
                System.out.println("Back to Town Hall");
                break;
        }
    }
    ...
    public void printRes(String place) {
        ...
        switch (option2()) {
            ...
            case 1:
                System.out.println("Go to Resident Profile");
                break;
            case 2:
