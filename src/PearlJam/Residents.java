...
<<<<<<< HEAD:src/PearlJam/Residents.java
...
public class Residents_P2 extends Restaurant_P2 {
    ...
    public ArrayList<String> ResidentialArea;
    public ArrayList<String> Parents;
    ArrayList<String> newName;
    ArrayList<String> newAge;
    ArrayList<String> newGender;
    ArrayList<String> newParent;
    ArrayList<String> newStand;
    ArrayList<String> newDes;
    ArrayList<String> newSpeed;
    ArrayList<String> newRange;
    ArrayList<String> newStamina;
    ArrayList<String> newPrecision;
    ArrayList<String> newDevPot;
    ArrayList<String> jonathan;
    ArrayList<String> joseph;
    ArrayList<String> josuke;
    ArrayList<String> jotaro;
    ArrayList<String> giorno;
    ArrayList<String> jolyne;
...
>>>>>>> f2d89c3cfdd737280f5c947b70f0eb4c6943c9aa:src/PartSal2/Residents_P2.java
...
>>>>>>> f2d89c3cfdd737280f5c947b70f0eb4c6943c9aa:src/PartSal2/Residents_P2.java
    ...
    public void readRes() {
        try {
            ...
            Scanner scan = new Scanner(new FileReader(filepath+"/residents.csv"));
            String line = "";
            scan.nextLine();
            ...
            if (values.get(3).equals("Joestar Mansion")) {
                ...
                switch (values.get(0)) {
                    ...
                    case "Jonathan Joestar":
                        jonathan.add(values.get(2));
                        System.out.println("dvknf");
                        break;

                    case "Joseph Joestar":
                        joseph.add(values.get(2));
                        break;

                    case "Jotaro Higashikata":
                        jotaro.add(values.get(2));
                        break;

                    case "Giorno Giovanna":
                        giorno.add(values.get(2));
                        break;

                    case "Jolyne Cujoh":
                        jolyne.add(values.get(2));
                        break;
