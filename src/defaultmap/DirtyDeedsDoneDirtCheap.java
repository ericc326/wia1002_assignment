...
public class DirtyDeedsDoneDirtCheap {
    ...
    public void prisonerTravel() {
        ...
        while (!myMap.hasLocation(source)) {
        ...
        while (!myMap.hasLocation(destination)) {
    ...
    private List<List<map.Location>> calculateShortestPaths(map myMap, String sourceLocation, String destinationLocation) {
        map.Location source = myMap.getLocationByName(sourceLocation);
        map.Location destination = myMap.getLocationByName(destinationLocation);
